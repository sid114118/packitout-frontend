...
// 3. THE FLOATING VIEW CART STRIP (Blinkit Style)
...
// 4. PRICE & ADD BUTTON ROW
export const PriceActionRow = ({ price, mrp, isDiscounted, discountPercent, cartCount, onAdd }) => (
  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '24px' }}>
    <div>
      <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px' }}>
        <div style={{ fontSize: '1.35rem', fontWeight: '900', color: '#0f172a', lineHeight: '1' }}>₹{price}</div>
        {isDiscounted && <div style={{ fontSize: '0.8rem', color: '#94a3b8', textDecoration: 'line-through' }}>₹{mrp}</div>}
      </div>
    </div>
    <button 
      onClick={onAdd}
      style={{ 
        ...
        border: '1px solid #0f9d58', padding: '0 16px', height: '38px', borderRadius: '8px', fontWeight: 'bold', fontSize: '0.95rem', cursor: 'pointer',
