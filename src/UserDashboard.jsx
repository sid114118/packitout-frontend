...
export default function UserDashboard({ onExit }) {
  return (
    <div style={{ backgroundColor: '#f4f7f6', minHeight: '100vh', fontFamily: 'sans-serif', paddingBottom: '30px' }}>
      ...
      <div style={{ backgroundColor: 'white', padding: '20px', margin: '-20px 15px 15px 15px', borderRadius: '12px', boxShadow: '0 4px 12px rgba(0,0,0,0.08)', position: 'relative' }}>
        <h3 style={{ margin: '0 0 5px 0', fontSize: '1.2rem', color: '#2f3640' }}>Demo User</h3>
        <p style={{ margin: '0 0 15px 0', color: '#7f8fa6', fontSize: '0.9rem' }}>+91 98765 43210 • Pincode: 110001</p>
        <div style={{ display: 'flex', gap: '10px' }}>
          ...
          <button style={{ flex: 1, padding: '10px', background: '#f5f6fa', color: '#2f3640', border: 'none', borderRadius: '8px', fontWeight: 'bold' }}>📍 Addresses (2)</button>
        </div>
      </div>

      {/* 📦 ACTIVE ORDERS (The most important part for a user) */}
      <div style={{ margin: '0 15px 20px 15px' }}>
        ...
        <div style={{ backgroundColor: 'white', padding: '15px', borderRadius: '12px', borderLeft: '5px solid #e1b12c', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
          ...
          {/* Progress Bar */}
          <div style={{ width: '100%', height: '6px', backgroundColor: '#f5f6fa', borderRadius: '10px', marginBottom: '15px' }}>
            <div style={{ width: '50%', height: '100%', backgroundColor: '#e1b12c', borderRadius: '10px' }}></div>
          </div>

          <button style={{ width: '100%', padding: '12px', background: '#fff9e6', color: '#e1b12c', border: '1px solid #fcf2ce', borderRadius: '8px', fontWeight: 'bold' }}>
            Track Live Status
          </button>
        </div>
      </div>
      ...
      <div style={{ margin: '0 15px' }}>
        ...
        <div style={{ backgroundColor: 'white', padding: '15px', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <button style={{ padding: '8px 16px', background: '#f5f6fa', color: '#ff4757', border: 'none', borderRadius: '6px', fontWeight: 'bold', fontSize: '0.85rem' }}>
              🔄 Reorder
            </button>
          </div>
        </div>
