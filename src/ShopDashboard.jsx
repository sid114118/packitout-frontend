    ...
    return (
      <div style={{ backgroundColor: '#f8fafc', minHeight: '100vh', fontFamily: 'sans-serif' }}>
        ...
        <div style={{ backgroundColor: '#ffffff', padding: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', boxShadow: '0 2px 10px rgba(0,0,0,0.05)' }}>
          <div>
            <h1 style={{ margin: 0, fontSize: '1.4rem', color: '#0f172a' }}>🏪 Sharma Groceries</h1>
            <span style={{ fontSize: '0.8rem', color: '#64748b' }}>Partner ID: SH-110001</span>
          </div>
        ...
        <div style={{ padding: '20px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: isShopOpen ? '#dcfce7' : '#fee2e2', padding: '15px', borderRadius: '12px', marginBottom: '20px' }}>
            <span style={{ fontWeight: 'bold', color: isShopOpen ? '#166534' : '#991b1b' }}>
              {isShopOpen ? '🟢 Accepting Orders' : '🔴 Store Closed'}
            </span>
            <button onClick={() => setIsShopOpen(!isShopOpen)} style={{ backgroundColor: isShopOpen ? '#16a34a' : '#ef4444', color: 'white', border: 'none', padding: '8px 16px', borderRadius: '20px', fontWeight: 'bold' }}>
              Turn {isShopOpen ? 'OFF' : 'ON'}
            </button>
          </div>

          {/* MONEY METRICS (What you requested!) */}
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px', marginBottom: '25px' }}>
            <div style={{ backgroundColor: '#ffffff', padding: '20px', borderRadius: '12px', boxShadow: '0 4px 6px rgba(0,0,0,0.05)', borderBottom: '4px solid #3b82f6' }}>
              <p style={{ margin: '0 0 5px 0', fontSize: '0.8rem', color: '#64748b', fontWeight: 'bold' }}>TODAY'S ORDERS</p>
              <h2 style={{ margin: 0, fontSize: '2rem', color: '#0f172a' }}>14</h2>
            </div>
            <div style={{ backgroundColor: '#ffffff', padding: '20px', borderRadius: '12px', boxShadow: '0 4px 6px rgba(0,0,0,0.05)', borderBottom: '4px solid #10b981' }}>
              <p style={{ margin: '0 0 5px 0', fontSize: '0.8rem', color: '#64748b', fontWeight: 'bold' }}>TODAY'S SALES</p>
              <h2 style={{ margin: 0, fontSize: '2rem', color: '#0f172a' }}>₹1,450</h2>
            </div>
          </div>
          ...
          <div style={{ backgroundColor: '#ffffff', padding: '15px', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)', borderLeft: '4px solid #f59e0b' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
              <span style={{ fontWeight: 'bold', fontSize: '1.1rem' }}>Order #1043</span>
              <span style={{ color: '#d97706', backgroundColor: '#fef3c7', padding: '4px 8px', borderRadius: '4px', fontSize: '0.8rem', fontWeight: 'bold' }}>Waiting...</span>
            </div>
            <p style={{ margin: '0 0 15px 0', color: '#475569', fontSize: '0.9rem' }}>Customer: Rahul (110001) • 3 Items • <strong>₹320</strong></p>
            <div style={{ display: 'flex', gap: '10px' }}>
              <button style={{ flex: 1, padding: '10px', backgroundColor: '#10b981', color: 'white', border: 'none', borderRadius: '8px', fontWeight: 'bold' }}>✅ Accept & Pack</button>
              <button style={{ padding: '10px', backgroundColor: '#f1f5f9', color: '#ef4444', border: 'none', borderRadius: '8px', fontWeight: 'bold' }}>Reject</button>
            </div>
          </div>
        </div>
  ...
  return (
    <div style={{ backgroundColor: '#f8fafc', minHeight: '100vh', fontFamily: 'sans-serif', paddingBottom: '70px' }}>
      ...
      <div style={{ padding: '20px' }}>
        ...
        <button style={{ width: '100%', padding: '15px', backgroundColor: '#ffffff', color: '#a855f7', border: '2px dashed #a855f7', borderRadius: '10px', fontWeight: 'bold', fontSize: '1rem' }}>
          ➕ Request Custom Item
        </button>
      </div>
